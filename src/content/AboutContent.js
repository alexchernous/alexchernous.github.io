...
export default function AboutContent() {
  return (
    <React.Fragment>
      ...
      <p>I want to engineer products for people who want to
        use them. If any contribution I provide helps make the final product
        easier and/or more enjoyable to use, that's a win. </p>
